...
draw_sprite_ext(FootSpr, myPantsType, foot1.x, foot1.y, -1+2*facingRight, 1, -foot1.phy_rotation, merge_color(c_white, c_dkgray, min((foot1.alarm[0]+1)/room_speed, 1)), 1)
draw_sprite_ext(FootSpr, myPantsType, foot2.x, foot2.y, -1+2*facingRight, 1, -foot2.phy_rotation, merge_color(c_white, c_dkgray, min((foot2.alarm[0]+1)/room_speed, 1)), 1)
draw_sprite_ext(ArmSpr, myShirtType, arm1.x, arm1.y, 1, 1, -arm1.phy_rotation, merge_color(c_white, c_dkgray, min((arm1.alarm[0]+1)/room_speed, 1)), 1)
draw_sprite_ext(ArmSpr, myShirtType, arm2.x, arm2.y, 1, 1, -arm2.phy_rotation, merge_color(c_white, c_dkgray, min((arm2.alarm[0]+1)/room_speed, 1)), 1)
draw_sprite_ext(HandSpr, myShirtType, hand1.x, hand1.y, 1, 1, -hand1.phy_rotation, merge_color(c_white, c_dkgray, min((hand1.alarm[0]+1)/room_speed, 1)), 1)
draw_sprite_ext(HandSpr, myShirtType, hand2.x, hand2.y, 1, 1, -hand2.phy_rotation, merge_color(c_white, c_dkgray, min((hand2.alarm[0]+1)/room_speed, 1)), 1)
*/
if stunned
    {
...
if handBall[0] > -1
    {
    draw_sprite_ext(DodgeBallSpr, handBall[0], hand1.x, hand1.y, 1, 1, 90, c_white, 1)
    if sticky
...
if handBall[1] > -1
    {
    draw_sprite_ext(DodgeBallSpr, handBall[1], hand2.x, hand2.y, 1, 1, 90, c_white, 1)
    if sticky
