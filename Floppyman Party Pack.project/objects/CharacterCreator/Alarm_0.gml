...
for(i=0; i<ds_list_size(joyStickList); i++)
    ...
    with instance_create(room_width/2,0,CharacterController)
        ...
        physics_joint_revolute_create(body, leg1, body.x-sprite_get_width(LegSpr)/2, body.y+sprite_get_height(BodySpr)/2, 0, 90, 1, 0, 0, 0, true)
        physics_joint_revolute_create(body, leg2, body.x+sprite_get_width(LegSpr)/2, body.y+sprite_get_height(BodySpr)/2, -90, 0, 1, 0, 0, 0, true)
