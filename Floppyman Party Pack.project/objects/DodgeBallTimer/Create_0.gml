...
ds_list_add(ballList, Bomb, EggBall, SuperBall, RocketBall, WaterBalloonBall, FootBall, Balloon, SoccerBall, BowlingBall)
...
for(i=0; i<ds_list_size(ballList); i++)
    {
    with instance_create(buttonX + (i div 3)*buttonXGap, buttonY + buttonYGap*(i%3), BallButton)
        {
