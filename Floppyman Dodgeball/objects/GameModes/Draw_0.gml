...
if startable
    ...
    if image_index = 0
        draw_text_transformed(x, y, string_hash_to_newline("READY"), size*testSize, size*testSize, 0)
    ...
    {
    draw_sprite_ext(sprite_index, image_index, x, y, size, size, 0, c_ltgray, 1)
    draw_set_font(CharacterCreator.winnerFont)
    draw_set_valign(fa_center)
    draw_set_halign(fa_middle)
