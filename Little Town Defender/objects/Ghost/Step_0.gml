...
if Stunned = false and !place_meeting(x,y,MonsterTarget) and !place_meeting(x,y,Hero) 
    {
...
if Stunned = false and place_meeting(x,y,MonsterTarget) or place_meeting(x,y,Hero)
    {
    sprite_index = GhostAttack
    image_speed = 8/60
