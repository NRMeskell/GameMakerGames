...
if instance_exists(Homestead) and Created = true
    {
    MyHomestead = instance_nearest(x,y,Homestead)
    if point_distance(MyHomestead.x, MyHomestead.y-8,x,y-8) < MyHomestead.Range and MyHomestead.Created = true
        {
        image_speed = 0.03
        if image_index < 1
            image_index = 6
