...
if Selected = true
    ...
    draw_text(__view_get( e__VW.WView, 0 ) - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge, __view_get( e__VW.HView, 0 ) - (sprite_get_height(MenuArea)*MenuSize) - Edge + CaptionPlace, string_hash_to_newline("Land Mine"))
    ...
    draw_text(__view_get( e__VW.WView, 0 ) - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge, __view_get( e__VW.HView, 0 ) - (sprite_get_height(MenuArea)*MenuSize) - Edge + UpgradePlace, string_hash_to_newline("")) 
   
    draw_set_valign(fa_center)
        
    draw_text(__view_get( e__VW.WView, 0 ) - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge, __view_get( e__VW.HView, 0 ) - (sprite_get_height(MenuArea)*MenuSize) - Edge + UpgradePlace + 5/2*Distance, string_hash_to_newline("Explodes When#Killed")) 
    
    HealthRed = make_colour_hsv(0,200,160)
    
    HealthGreen = make_colour_hsv(80,220,80)
    
    /*draw_rectangle_colour(view_wview - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge - 25, view_hview - (sprite_get_height(MenuArea)*MenuSize)* 2/3 - Edge + 1 + 41, view_wview - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge + 25, view_hview - (sprite_get_height(MenuArea)*MenuSize)* 2/3 - Edge + 1 + 38, c_black, c_black, c_black, c_black, false)
    draw_rectangle_colour(view_wview - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge - 25, view_hview - (sprite_get_height(MenuArea)*MenuSize)* 2/3 - Edge + 1 + 41, view_wview - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge - 25 + ((Health/MaxHealth) * 50), view_hview - (sprite_get_height(MenuArea)*MenuSize)* 2/3 - Edge + 1 + 38, HealthGreen, HealthGreen, HealthGreen, HealthGreen, false)
    draw_rectangle_colour(view_wview - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge - 25, view_hview - (sprite_get_height(MenuArea)*MenuSize)* 2/3 - Edge + 1 + 41, view_wview - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge + 25, view_hview - (sprite_get_height(MenuArea)*MenuSize)* 2/3 - Edge + 1 + 38, c_black, c_black, c_black, c_black, true)
    */
    draw_set_valign(fa_top)
    ...
    draw_set_font(CaptionFont)
    draw_text(__view_get( e__VW.WView, 0 ) - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge, __view_get( e__VW.HView, 0 ) - (sprite_get_height(MenuArea)*MenuSize)* 2/5 - Edge-5, string_hash_to_newline("Detonate")) 
    }
