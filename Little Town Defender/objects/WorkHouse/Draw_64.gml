...
if Selected = true
    ...
    draw_text(__view_get( e__VW.WView, 0 ) - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge, __view_get( e__VW.HView, 0 ) - (sprite_get_height(MenuArea)*MenuSize) - Edge + CaptionPlace, string_hash_to_newline("Work House"))
    ...
    draw_sprite(ResourcesSpr, 3, __view_get( e__VW.WView, 0 ) - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge + 6, __view_get( e__VW.HView, 0 ) - (sprite_get_height(MenuArea)*MenuSize) - Edge + UpgradePlace + 5/2*Distance) 
   
    draw_set_valign(fa_center)
    draw_text(__view_get( e__VW.WView, 0 ) - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge - 6, __view_get( e__VW.HView, 0 ) - (sprite_get_height(MenuArea)*MenuSize) - Edge + UpgradePlace + 5/2*Distance, string_hash_to_newline("+1")) 
    ...
    /*
    if Level < 2
        draw_text(view_wview - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge, view_hview - (sprite_get_height(MenuArea)*MenuSize)* 2/5 - Edge + 2, 'Upgrade') 
    
    if Level = 2
        draw_text(view_wview - (sprite_get_width(MenuArea)*MenuSize)/2 - Edge, view_hview - (sprite_get_height(MenuArea)*MenuSize)* 2/5 - Edge + 2, 'No Upgrade') 
    */    
    }
...
/*if point_in_rectangle(mouse_x, mouse_y, ButtonLeft1, ButtonTop2, ButtonRight1, ButtonBottom2)
    ...
    draw_text(mouse_x + sprite_get_width(MenuArea) * 0.25 + 5, mouse_y + DistanceDraw, global.BetterWorkerCost)
    draw_text(mouse_x + sprite_get_width(MenuArea) * 0.25 + 5, mouse_y + 2*DistanceDraw,  global.BetterWorkerWood)
    draw_text(mouse_x + sprite_get_width(MenuArea) * 0.25 + 5, mouse_y + 3*DistanceDraw, global.BetterWorkerStone)
