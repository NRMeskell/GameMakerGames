...
if x>=0 and x<room_width and y>=0 and y<room_height{
    ...
    if place_meeting(x, y-10, Door){
		myDoor = instance_nearest(x, y-10, Door)
		draw_sprite_ext(myDoor.sprite_index, myDoor.image_index, myDoor.x, myDoor.y, 1, 1, 0, myDoor.myColor, 1)
	}
	...
	if place_meeting(x, y+10, Door){
		myDoor = instance_nearest(x, y+10, Door)
		draw_sprite_ext(DoorVertWallSpr, 0, x, y, 1, 1, 0, myDoor.myColor, 1)
	}
}
