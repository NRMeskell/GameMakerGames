function FrogsArrive() {
	...
	with instance_create(0,0,Event)
	    ...
	    ds_list_add(buttonRequires, 0, global.eventDiff[3, 2], max(1, global.eventDiff[5, 2] - (searchReputationType("nature")[0] div 2), global.eventDiff[5, 2] - searchReputationType("frog")[0]))
	    ds_list_add(buttonCosts, 0, 0, 0)
	    ds_list_add(buttonText, "prepare for battle", "run away", "try to negotiate")
	    ...
	    with myShip
	        {
	        myShipType = choose(TropicalEnemy, TropicalEnemySword)
