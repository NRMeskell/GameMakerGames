function GiantTurtleSmall() {
	with instance_create(0,0,Event)
	    ...
	    myCharacter = 5
	    buttonNumber = 3
	    ds_list_add(buttons, GiantTurtleFeed, GiantTurtleJewel, GiantTurtleSmallTake) 
	    ...
	    eventText = "the sea turtle returns, with what appears to be a small gift on its back" 
