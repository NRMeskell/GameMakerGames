...
ds_list_add(normalEventList, Shortcut, SpoiledFood, Stowaway, RottenPlanks, BirdsArrive, PlagueShip, MerchantArrive, RaftPirate, DolphinsArrive, FloatingBarrel, FloatingBarrel)
ds_list_add(roughEventList, SeaSickPirates, ManOverboard, SeaSickPirates, MastDamaged)

ds_list_add(eventList[0], SupplyBoxArrive, RaftPirate, Stowaway, TradingPostArrive, PirateShipArrive, FloatingBarrel, PirateShipArrive, TradingPostArrive, PirateShipArrive, TradingPostArrive)
ds_list_add(eventList[1], MermaidRocks, TropicalFishArrive, BugsAttack, StrangeAnimal, TropicalHeat, FrogsArrive, BirdsArrive, DolphinsArrive, SpoiledFood, PirateShipArrive, RottenPlanks)
