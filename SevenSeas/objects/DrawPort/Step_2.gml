...
for(i=0; i<buttonNumber; i++)
    ...
    overMenuButton[i] = point_in_rectangle(mouse_x, mouse_y, x-sprite_get_width(LandMenuButtonSpr)/2, y-drawButtonHeight-sprite_get_height(LandMenuButtonSpr)/2, x+sprite_get_width(LandMenuButtonSpr)/2, y-drawButtonHeight+sprite_get_height(LandMenuButtonSpr)/2)

    }
    
if !overButton
    overButton = distance_to_point(mouse_x,mouse_y) < 1
else
