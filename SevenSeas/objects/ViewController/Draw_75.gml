...
draw_rectangle(-abs((window_get_width()-realWidths[global.resolution]))/2, 0, 0, room_height, false)
draw_rectangle(0, -abs((window_get_height()-realHeights[global.resolution]))/2, room_width, 0, false)
