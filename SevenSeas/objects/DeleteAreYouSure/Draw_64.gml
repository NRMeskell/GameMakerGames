...
draw_text_ext_transformed(drawX, drawY - notificationSize/2 + captionSize/2 + textSize/2 + 7, string_hash_to_newline(text), 10, sprite_get_width(NotifacationSpr) - 20 - animationBorder*2, 0.8, 0.8, 0)
