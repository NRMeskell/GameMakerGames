...
if alarm[0] < 1{
    ...
    //if Ship.myHealth < 1 or instance_exists(CombatRunner){
        ...
        DrawWithOutline(GrassSpr, image_index, drawX -75, drawY, 0, c_white, 1, 1)
        DrawWithOutline(GrassSpr, image_index + 6, drawX + 82, drawY - 15, 0, c_white, 1, 1)
        ...
        DrawWithOutline(GrassSpr, image_index + 2, drawX + 42, drawY + 36, 0, c_white, 1, 1)
        }
